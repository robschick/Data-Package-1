...
```{r locations}
locations <- read_csv("/cloud/project/PackageFolder/BRSPackage/inst/extdata/raw_data/All_Locations.csv")
...
```{r aux}
aux <- read_csv("/cloud/project/PackageFolder/BRSPackage/inst/extdata/raw_data/2019_AuxDataErrorStructure_20200609.csv") %>%
...
```{r gonio}
gonio <- read_csv('/cloud/project/PackageFolder/BRSPackage/inst/extdata/raw_data/gonio_gpx_merge_2019.csv')
gonio <- gonio %>%
